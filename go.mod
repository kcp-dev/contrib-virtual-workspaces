module github.com/kcp-dev/contrib-virtual-ephemeral-resources-virtual-workspace
...
// The virtual workspace framework and the kcp SDK are built against kcp's fork
// of the Kubernetes staging repositories. Every consumer of them has to carry
// the same replace block, because replace directives in dependencies are
